...
// Оптимизированная база аккордов для автокомплита (только самые популярные)
const chordDatabase = [
...
/**
 * Отрисовка грифа гитары (оптимизированная версия)
 */
function drawFretboard() {
    ...
    // Добавляем все элементы в SVG за одну операцию
